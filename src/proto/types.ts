...
export type ServerMethods = {
    ...
    LegacyGetNostrPubKey?: (req: LegacyGetNostrPubKey_Input & {ctx: LegacyAccessTokenContext, requestObject: Request, responseObject: Response }) => Promise<void>
    LegacyGetNostrRelays?: (req: LegacyGetNostrRelays_Input & {ctx: LegacyAccessTokenContext, requestObject: Request, responseObject: Response }) => Promise<void>
    LegacySignNostrEvent?: (req: LegacySignNostrEvent_Input & {ctx: LegacyAccessTokenContext, requestObject: Request, responseObject: Response }) => Promise<void>
    LegacyNip44Decrypt?: (req: LegacyNip44Decrypt_Input & {ctx: LegacyAccessTokenContext, requestObject: Request, responseObject: Response }) => Promise<void>
    LegacyNip44Encrypt?: (req: LegacyNip44Encrypt_Input & {ctx: LegacyAccessTokenContext, requestObject: Request, responseObject: Response }) => Promise<void>
    LegacyNip98Event?: (req: LegacyNip98Event_Input & {ctx: LegacyAccessTokenContext, requestObject: Request, responseObject: Response }) => Promise<void>
