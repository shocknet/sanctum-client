...
export type SignUpWithNsec_Input = {rpcName:'SignUpWithNsec', req: SignupWithNsecRequest}
export type SignUpWithNsec_Output = ResultError | ({ status: 'OK' } & AuthWithNsecResponse)
...
export type LoginWithNsec_Input = {rpcName:'LoginWithNsec', req: LoginWithNsecRequest}
export type LoginWithNsec_Output = ResultError | ({ status: 'OK' } & AuthWithNsecResponse)
...
export type ServerMethods = {
    ...
    AuthEmail?: (req: AuthEmail_Input & {ctx: GuestContext, requestObject: Request }) => Promise<AuthResponse>
    ...
    GetRequestTokenData?: (req: GetRequestTokenData_Input & {ctx: GuestContext, requestObject: Request }) => Promise<GetRequestTokenDataResponse>
    GetAuthRequestInfo?: (req: GetAuthRequestInfo_Input & {ctx: GuestContext, requestObject: Request }) => Promise<GetAuthRequestInfoResponse>
    DeleteAccessToken?: (req: DeleteAccessToken_Input & {ctx: UserContext, requestObject: Request }) => Promise<void>
    Nip98Event?: (req: Nip98Event_Input & {ctx: AccessTokenContext, requestObject: Request }) => Promise<Nip98EventResponse>
    SignUpWithNsec?: (req: SignUpWithNsec_Input & {ctx: GuestContext, requestObject: Request }) => Promise<AuthWithNsecResponse>
    SignupWithNsecAccessToken?: (req: SignupWithNsecAccessToken_Input & {ctx: GuestContext, requestObject: Request }) => Promise<SignupWithNsecAccessTokenResponse>
    LoginWithNsec?: (req: LoginWithNsec_Input & {ctx: GuestContext, requestObject: Request }) => Promise<AuthWithNsecResponse>
}
...
export const GetAuthRequestInfoResponseValidate = (o?: GetAuthRequestInfoResponse, opts: GetAuthRequestInfoResponseOptions = {}, path: string = 'GetAuthRequestInfoResponse::root.'): Error | null => {
    ...
    if (typeof o.login !== 'boolean') return new Error(`${path}.login: is not a boolean`)
    if (opts.login_CustomCheck && !opts.login_CustomCheck(o.login)) return new Error(`${path}.login: custom check failed`)
...
export const LoginWithNsecRequestOptionalFields: [] = []
export type LoginWithNsecRequestOptions = OptionsBaseMessage & {
    checkOptionalsAreSet?: []
    nostr_secret_CustomCheck?: (v: string) => boolean
}
export const LoginWithNsecRequestValidate = (o?: LoginWithNsecRequest, opts: LoginWithNsecRequestOptions = {}, path: string = 'LoginWithNsecRequest::root.'): Error | null => {
    if (opts.checkOptionalsAreSet && opts.allOptionalsAreSet) return new Error(path + ': only one of checkOptionalsAreSet or allOptionalNonDefault can be set for each message')
    if (typeof o !== 'object' || o === null) return new Error(path + ': object is not an instance of an object or is null')
...
export const NostrSignRequestValidate = (o?: NostrSignRequest, opts: NostrSignRequestOptions = {}, path: string = 'NostrSignRequest::root.'): Error | null => {
    ...
    if (typeof o.unsigned_event !== 'string') return new Error(`${path}.unsigned_event: is not a string`)
    if (opts.unsigned_event_CustomCheck && !opts.unsigned_event_CustomCheck(o.unsigned_event)) return new Error(`${path}.unsigned_event: custom check failed`)
...
export const NostrSignResponseValidate = (o?: NostrSignResponse, opts: NostrSignResponseOptions = {}, path: string = 'NostrSignResponse::root.'): Error | null => {
    ...
    if (typeof o.signed_event !== 'string') return new Error(`${path}.signed_event: is not a string`)
    if (opts.signed_event_CustomCheck && !opts.signed_event_CustomCheck(o.signed_event)) return new Error(`${path}.signed_event: custom check failed`)
...
export const SignupWithNsecRequestOptionalFields: SignupWithNsecRequestOptionalField[] = ['request_token']
export type SignupWithNsecRequestOptions = OptionsBaseMessage & {
    checkOptionalsAreSet?: SignupWithNsecRequestOptionalField[]
    nostr_secret_CustomCheck?: (v: string) => boolean
    request_token_CustomCheck?: (v?: string) => boolean
}
export const SignupWithNsecRequestValidate = (o?: SignupWithNsecRequest, opts: SignupWithNsecRequestOptions = {}, path: string = 'SignupWithNsecRequest::root.'): Error | null => {
    if (opts.checkOptionalsAreSet && opts.allOptionalsAreSet) return new Error(path + ': only one of checkOptionalsAreSet or allOptionalNonDefault can be set for each message')
    if (typeof o !== 'object' || o === null) return new Error(path + ': object is not an instance of an object or is null')
